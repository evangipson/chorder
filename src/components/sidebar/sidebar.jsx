...
const closeSidebar = (blurEvent) => {
    ...
    if (!sidebarElement.contains(blurEvent.relatedTarget)) {
...
const updateRange = () => {
    ...
    AudioService.setVolume(rangePercentage / 1000);
};
    ...
    return (
        <div className='chorder__sidebar' onBlur={closeSidebar} tabIndex={-1}>
            ...
            <div className='chorder__input'>
                <label className='chorder__input-label' htmlFor='volume'>Volume</label>
            ...
            <div className='chorder__sidebar-toggle' onClick={toggleSidebar}>
                ...
                <svg className='chorder__sidebar-toggle-icon chorder__sidebar-toggle-icon--muted' xmlns="http://www.w3.org/2000/svg" viewBox="0 0 320 512">
